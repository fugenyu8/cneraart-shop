  ...
  const configuration: ChartConfiguration = {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: data.values,
        backgroundColor: [
          'rgba(212, 175, 55, 0.8)', // 金黄色
          'rgba(0, 0, 139, 0.8)',    // 深蓝色
          'rgba(139, 0, 0, 0.8)'     // 深红色
        ],
        borderColor: [
          'rgba(212, 175, 55, 1)',
          'rgba(0, 0, 139, 1)',
  ...
  const configuration: ChartConfiguration = {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: data.scores,
        backgroundColor: [
          'rgba(212, 175, 55, 0.6)',  // 乾(西北)
          'rgba(0, 100, 0, 0.6)',     // 坤(西南)
          'rgba(139, 0, 0, 0.6)',     // 震(东)
          'rgba(0, 0, 139, 0.6)',     // 巽(东南)
          'rgba(255, 215, 0, 0.6)',   // 坎(北)
          'rgba(255, 140, 0, 0.6)',   // 离(南)
          'rgba(128, 0, 128, 0.6)',   // 艮(东北)
          'rgba(0, 128, 128, 0.6)'    // 兑(西)
        ],
        borderColor: [
          'rgba(212, 175, 55, 1)',
          'rgba(0, 100, 0, 1)',
